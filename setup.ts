...
function printBanner() {
  ...
  console.log(colorize('║     Agent Ironman - User Setup          ║', 'cyan'));
  console.log(colorize('╚═══════════════════════════════════════╝', 'cyan'));
  console.log('');
}
...
export async function runSetup() {
  ...
  // Ask for name
  console.log(colorize('Let\'s personalize Agent Ironman for you!', 'bright'));
  console.log('');
  ...
  console.log(colorize('  agent-ironman --setup', 'cyan'));
