...
async function handleLogin() {
  console.log('\n🔐 Agent Ironman - Claude OAuth Login\n');
...
async function handleLogout() {
  console.log('\n👋 Agent Ironman - Claude OAuth Logout\n');
...
function showHelp() {
  console.log(`
🤖 Agent Ironman - OAuth Authentication CLI
...
Note: This CLI is for OAuth authentication only.
      Use 'agent-ironman' command to launch the app (standalone binary).
`);
}
