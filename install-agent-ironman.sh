...
# =============================================================================
# Agent Ironman Installer - Production Grade
# =============================================================================
...
download_release() {
  log_section "Downloading Agent Ironman $VERSION"
...
extract_and_install() {
  log_section "Installing Agent Ironman"
  ...
  # The zip contains a directory named agent-ironman-{platform}
...
EOF
    ...
    log_info "Skipped personalization (you can run 'agent-ironman --setup' later)"
  fi
}
...
show_success_message() {
  ...
  echo -e "${GREEN}Agent Ironman $VERSION has been installed successfully!${NC}"
  echo ""
  ...
  echo ""
  echo -e "${BLUE}🌐 The app will start at:${NC} ${CYAN}http://localhost:3003${NC}"
  echo ""
...
main() {
  ...
  echo ""
  echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo -e "${CYAN}   Agent Ironman Installer${NC}"
